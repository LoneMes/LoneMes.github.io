...
function girlmove(a) {
  $("#box3d_girl").css({ left: w / 2 - (a.pageX - w / 2) / 50 + "px" });
}
...
function show1Img() {
  ...
  if (tagi >= 4) {
    ...
    a.style.backgroundImage = "url(kernel/index/img/welcome/y" + tagi + ".jpg)";
    setTimeout(function() {
      a.classList.add("s_tran");
    }, 30);
  }
}
function show2Img() {
  ...
  a.classList.remove("show2_s_tran");
  b.classList.remove("show2_s2_tran");
  tagi++;
  if (tagi >= 4) {
    ...
    setTimeout(function() {
      a.classList.add("show2_s_tran");
      b.classList.add("show2_s2_tran");
    }, 30);
  }
}
function show3Img() {
...
var returninith =
  '<div id="left"></div><div id="right"></div><div id="s_2"></div><div id="s"></div><div id="words"></div><div id="s3d"><div class="s3d_d" id="s3d_1"></div><div class="s3d_d" id="s3d_2"></div><div class="s3d_d" id="s3d_3"></div><div class="s3d_d" id="s3d_4"></div><div class="s3d_d" id="s3d_5"></div><div class="s3d_d" id="s3d_6"></div><div class="s3d_d" id="s3d_7"></div><div class="s3d_d" id="s3d_8"></div><div class="s3d_d" id="s3d_9"></div><div class="s3d_d" id="s3d_10"></div></div><div class="lastword" id="word1">isLuo</div><div class="lastword" id="word2">我就是我 是颜色不一样的烟火</div><div class="lastword" id="word3">欢迎访问我的世界</div><div class="lastword" id="word4">isluo.com</div>';
function returnInit() {
