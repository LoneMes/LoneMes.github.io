...
if(tmp)isIE = document.namespaces ? 1 : 0;
...
function addIEReflex(the) {
	...
	//for(i=0;i<theimages.length;i++) {	
		image = the; object = image.parentNode; j = 0;
		itiltright = 0; itiltnone = 0; itiltleft = 0; 
		iheight = 33; iopacity = 33; idistance = 0;
		iborder = 0; icolor = 'transparent'; iradius = 0; 
		if(image.width>=32 && image.height>=32) {
			...
			colr = (icolor!=0?icolor:'transparent');
...
function addReflex(the) {
	...
	//for(i=0;i<theimages.length;i++) {	
		image = the; object = image.parentNode; tmp = 0;
		itiltright = 0; itiltnone = 0; itiltleft = 0; 
		iheight = 33; iopacity = 33; idistance = 0;
		iborder = 0; icolor = 'transparent'; iradius = 0; 
