...
const users = [
  { n: "Logic", s: 10 },
  { n: "士大夫(大赞)", s: 5,c:"100010810120180930231002666****" },
  ...
  { n: "太苦特级方糖(希望捐给猫猫)", s: 1, c: "100010810120180929252002402****" },
  { n: "天将明(探索未知)", s: 5,c:"100010810120180929371003526****" },
  ...
  { n: ["libs/imgs/users/niu.png"], s: 1,c:"100010810120180623282002282****" },
  { n: "moleQ(我又来了)", s: 1.01,c:"100010810120180623242002460****" },
  { n: ["西瓜丸子", "libs/imgs/users/xigua.png"], s: 1 },
  { n: "呐-是小中(66)", s: 0.01,c:"100010810120180714381002286****" },
  ...
  { n: "浮生六记(ETO成员前来报告)", s: 1,c:"100010810120200325242207116****"},
  { n: "Z(Hala Madrid)", s: 1,c:"100010810120200518241101803****" },
];
